...
- شاشة بداية بالشعار وخيارين: شراء عقار أو استثمار على أرض مستأجرة.
- حفظ تلقائي للمشروع في المتصفح مع إمكانية استرجاع آخر مشروع محفوظ.
- إدخال تكاليف الأرض، البناء، التطوير، الإيرادات، المصاريف، والتمويل البنكي الاختياري.
- رسوم السعي أو الوساطة تقبل مبلغاً خاماً أو نسبة من قيمة العقار.
- الصيانة السنوية تقبل مبلغاً خاماً أو نسبة من الإيراد السنوي.
- حساب نسبة البناء/المسطح إلى الأرض.
...
- تصدير تقرير PDF مباشر واحترافي باللغة العربية يتضمن الشعار، الغلاف، الجداول، الرسوم البيانية، التوصية، والملاحظة القانونية.
