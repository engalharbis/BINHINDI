...
- وضع الاستثمار يحسب مشروعاً على أرض مستأجرة ولا يفترض امتلاك الأرض أو بيعها في نهاية الدراسة.
...
- رسوم السعي أو الوساطة تقبل مبلغاً ثابتاً أو نسبة من قيمة العقار.
- الصيانة السنوية تقبل مبلغاً ثابتاً أو نسبة من الإيراد السنوي.
- مسطح البناء يدعم الإدخال اليدوي أو الحساب التلقائي: مساحة الأرض × نسبة البناء × عدد الأدوار.
- إمكانية إظهار/إخفاء تفاصيل التكاليف الإضافية والمصاريف التشغيلية لتقليل التعقيد.
- التمويل البنكي يدعم إدخال مبلغ التمويل أو نسبة من تكلفة المشروع.
- مؤشرات مالية إضافية: IRR وNPV وسنة الاسترداد.
- جدول تدفقات نقدية لعشر سنوات مع الإيرادات، إيجار الأرض، المصاريف، التمويل، الصافي، والتراكمي.
...
إجمالي تكلفة تملك الأرض عند الشراء:

```text
قيمة الأرض + رسوم السعي + ضريبة التصرفات العقارية + الرسوم الأخرى
```

تكاليف الأرض المستأجرة:

```text
رسوم السعي + الرسوم الأخرى
```

مسطح البناء التلقائي:

```text
مساحة الأرض × نسبة البناء × عدد الأدوار
```
...
```text
القيمة الحالية للتدفقات السنوية بمعدل خصم 10٪ - إجمالي تكلفة المشروع
```

IRR:

```text
معدل الخصم الذي يجعل صافي القيمة الحالية للتدفقات النقدية يساوي صفر
```
